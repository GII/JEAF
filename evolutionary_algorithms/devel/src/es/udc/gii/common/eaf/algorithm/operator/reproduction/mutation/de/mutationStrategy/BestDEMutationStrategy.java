 ...
 * implements the best strategy. Following this strategy a new mutation vector
 * is generated as follows:
 * <p>
 *
 * v<sub>i,g</sub> = x<sub>best,g</sub> + F&sdot;(x<sub>r1,g</sub> -
 * x<sub>r2,g</sub>)
 * <p>
 *
 * where best is the index of the best individual of the population and r1 and
 * r2 are distinct integers uniformely chosen from from the set <i>{1, 2,
 * &hellip;, NP}</i>
...
public class BestDEMutationStrategy extends DEMutationStrategy {
    ...
    public Individual getMutatedIndividual(EvolutionaryAlgorithm algorithm, Individual target) {
        ...
        base = ((Individual) IndividualsProductTrader.get(bestSpec,
                ...
                algorithm.getComparator()).get(0)).getChromosomeAt(0);
