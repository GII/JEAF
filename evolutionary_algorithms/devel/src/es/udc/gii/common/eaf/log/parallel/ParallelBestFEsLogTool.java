 ...
 * function evaluations the best individual of the population is logged. The
 * log is written after the replace state and after the final state.<p/>
 *
 * The output reads as follows:
 * The best individual per line per {@code Fes_Prints}.
 *
 ...
 * @since 1.0
 * 
 * @see ParallelFEsLogTool
 */
public class ParallelBestFEsLogTool extends ParallelLogTool {
    ...
    public ParallelBestFEsLogTool(List fes_prints) {
        this.fes_prints = fes_prints;
    }
